-- Migration: Fix DM relay user ID fields to support 64-bit Telegram IDs
-- Date: 2026-01-21
-- Description: Change from_user_id, to_user_id in dm_relays and read_by in dm_read_receipts from INTEGER to BIGINT
